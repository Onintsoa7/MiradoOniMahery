<script>
    var valeur = <?php echo $error; ?>;

    // Vérifier si la valeur existe
    if (valeur === undefined || valeur === null || valeur === '') {} else {
        var messageErreur = "Le montant de votre porte monnaie est insuffisant, veuillez le recharger";
        alert(messageErreur);
    }
</script>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-8 col-lg-9 col-md-12 ">
                            <div class="hero__caption hero__caption3 text-center">
                                <h1 data-animation="fadeInLeft" data-delay=".6s ">Changer vos habitudes avec Mom</h1>
                            </div>
                        </div>
                    </div>
                </div>
